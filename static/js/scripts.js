...
function initSolonick() {
  ...
  $("<div class='half-bg-dec-item'></div>")
    .duplicate(12)
    .appendTo('.half-bg-dec');
  $(
    "<div class='hidden-works-item-dec'><i class='fal fa-arrow-left'></i></div>"
  ...
  $('.hidden-info-wrap-bg').scrollToFixed({
    ...
    limit: function () {
      var a =
        ...
        $('.hidden-info-wrap-bg').outerHeight(true);
      return a;
    },
  });
  ...
  if (
    ...
    $('.fixbar-action').scrollToFixed({
      ...
      limit: function () {
        var a =
          $('.limit-box').offset().top - $('.fixed-bar').outerHeight() - 20;
        return a;
      },
    });
  ...
  scs.on('init', function (event, slick) {
    fetcarCounter.text(
      Number(slick.currentSlide + 1) + ' / ' + slick.slideCount
    );
  });
  scs.slick({
    dots: true,
  ...
  $('.bg-ser .bg:first-child')
    .addClass('active')
    .css('background-image', 'url(' + actbgindex + ')');
  $('.hidden-works-item').on('mouseover', function () {
    ...
    $('.bg-ser .bg')
      ...
      .eq(hidworit_index)
      .addClass('active')
      .css('background-image', 'url(' + hidworit_index_each + ')');
  });
  //   lightGallery------------------
  ...
  $(
    "<div class='to-top-letter'>t</div><div class='to-top-letter'>o</div><div class='to-top-letter'>p</div>"
